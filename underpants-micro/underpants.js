...
_.indexOf = function(array, item) {
    var result = 0;
    while (!(result === array.length || array[result] === item)) {
        result++;
    }
...
_.each = function(array, funct) {
    for (var item = 0; item < array.length; item++) {
        funct(array[item], item, array);
    }
}
...
_.filter = function(array, funct) {
    var result = [];
    for (var item = 0; item < array.length; item++) {
        if (funct(array[item], item, array)) {
...
_.map = function(array, funct) {
    var result = [];
    for (var item = 0; item < array.length; item++) {
        result.push(funct(array[item], item, array));
    }
    return result;
}
