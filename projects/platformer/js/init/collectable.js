(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 400, 560, 8, 2);
        collectable.create(type.grace, 460, 500, 4, 0.65);
        collectable.create(type.steve, 575, 360, 4, 0.65)
        collectable.create(type.max, 300, 400);
